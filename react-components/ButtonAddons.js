...
const INFO_CONTENT = '  Please ensure that the log files are should be valid. For Example ( log.txt, serverlog.txt, samplelog.txt ), you can use the same file names for the demo.'
